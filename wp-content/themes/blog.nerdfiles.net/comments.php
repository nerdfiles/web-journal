...
<?php $blogtxt_comment_alt = 0 // Resets comment count for .alt classes for pingbacks ?>
	...
	<h2 class="comment-header" id="numpingbacks"><?php printf(__($ping_count > 1 ? 'Trackbacks &amp; Pingbacks <span class="comment-count">%d</span>' : 'Trackbacks &amp; Pingbacks <span class="comment-count">1</span>', 'blogtxt'), $ping_count) ?></h2>
