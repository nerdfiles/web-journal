...
<?php the_post() ?>
<?php if ( is_day() ) : ?>
				<h2 class="page-title"><?php _e('Daily Archives', 'webjournal') ?> <span class="page-subtitle"><?php the_time(__('l, F Y', 'webjournal')) ?></span></h2>
<?php elseif ( is_month() ) : ?>
				<h2 class="page-title"><?php _e('Monthly Archives', 'webjournal') ?> <span class="page-subtitle"><?php the_time(__('F Y', 'webjournal')) ?></span></h2>
<?php elseif ( is_year() ) : ?>
				<h2 class="page-title"><?php _e('Yearly Archives', 'webjournal') ?> <span class="page-subtitle"><?php the_time(__('Y', 'webjournal')) ?></span></h2>
<?php elseif ( is_author() ) : ?>
				<h2 class="page-title"><?php _e('Author Archives', 'webjournal') ?> <span class="page-subtitle"><?php webjournal_author_hCard() ?></span></h2>
...
<?php elseif ( is_category() ) : ?>
				<h2 class="page-title"><?php _e('Category Archives:', 'webjournal') ?> <span class="page-subtitle"><?php echo single_cat_title(); ?></span></h2>
<?php elseif ( is_tag() ) : ?>
