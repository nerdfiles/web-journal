...
<?php if (have_posts()) : ?>
                ...
                <!--
                    div><?php _e('Search Results', 'blogtxt') ?> <span class="page-subtitle"><?php the_search_query() ?></span></div
                -->
...
<?php else : ?>
				...
				<h2 class="page-title"><?php _e('Search Results', 'blogtxt') ?> for '<span class="page-subtitle"><?php printf(__('%1$s', 'blogtxt'), wp_specialchars(stripslashes($_GET['s']), true) ); ?></span>'</h2>
