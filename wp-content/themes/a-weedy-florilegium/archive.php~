...
== -->
  ...
  <?php elseif ( is_author() ) : ?>
    ...
    <div class="author-callout">
      <ul><?php if ( !(''== $authordata->user_description) ) : echo '<li>' . apply_filters('archive_meta', $authordata->user_description) . '</li>'; endif; ?><?php if ( !(''== $authordata->user_url) ) : echo '<li><a href="' . apply_filters('archive_meta', $authordata->user_url) . '">' . apply_filters('archive_meta', $authordata->user_url) . '</a></li>'; endif; ?></ul>
    </div>
